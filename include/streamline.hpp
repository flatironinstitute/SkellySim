...
class StreamLine {
  public:
    ...
    StreamLine(CVectorRef &x0_, double dt_init_, double t_final_, double abs_err_, double rel_err_,
...
class VortexLine : public StreamLine {
  public:
    ...
    VortexLine(CVectorRef &x0_, double dt_init_, double t_final_, double abs_err_, double rel_err_,
               bool back_integrate_) {
        x = x0_;
        dt_init = dt_init_;
        t_final = t_final_;
