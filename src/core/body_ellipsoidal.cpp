...
void EllipsoidalBody::step(double dt, CVectorRef &body_solution) {
...
Eigen::VectorXd EllipsoidalBody::apply_preconditioner(CVectorRef &x) const { return A_LU_.solve(x); }

Eigen::VectorXd EllipsoidalBody::matvec(CMatrixRef &v_body, CVectorRef &x_body) const {
...
void EllipsoidalBody::update_RHS(CMatrixRef &v_on_body) {
